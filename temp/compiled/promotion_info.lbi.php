...
<div class="mod1 mod2 blank" id="promotionInfo" style="border-top:none;" >
	...
	<h1 class="left_title"><?php echo $this->_var['lang']['promotion_info']; ?></h1>
	<div class="mod2con">
...
?>
    ...
    <?php endif; ?>
    <a href="<?php echo $this->_var['item']['url']; ?>" title="<?php echo $this->_var['lang'][$this->_var['item']['type']]; ?> <?php echo $this->_var['item']['act_name']; ?><?php echo $this->_var['item']['time']; ?>"><?php echo sub_str($this->_var['item']['act_name'],15); ?></a><br />
