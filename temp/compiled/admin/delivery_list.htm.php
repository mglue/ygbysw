...
<div class="form-div">
  <form action="javascript:searchOrder()" name="searchForm">
    ...
    <?php echo $this->_var['lang']['label_delivery_sn']; ?><input name="delivery_sn" type="text" id="delivery_sn" size="20">
    <?php echo $this->_var['lang']['order_sn']; ?><input name="order_sn" type="text" id="order_sn" size="20">
    <?php echo htmlspecialchars($this->_var['lang']['consignee']); ?><input name="consignee" type="text" id="consignee" size="20">
