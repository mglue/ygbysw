        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          <tr>
            ...
            <input type="button" value="<?php echo $this->_var['lang']['compute_by_mp']; ?>" onclick="marketPriceSetted()" class="marketPriceSetted"/>
            <?php echo $this->_var['lang']['require_field']; ?></td>
          </tr>
          ...
          <tr>
            ...
            <td class="input_ie7">
            <div class="rank_list_detail">
              <span><?php $_from = $this->_var['user_rank_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user_rank');if (count($_from)):
    foreach ($_from AS $this->_var['user_rank']):
?></span>
              <span><?php echo $this->_var['user_rank']['rank_name']; ?></span><span id="nrank_<?php echo $this->_var['user_rank']['rank_id']; ?>"></span><input type="text" id="rank_<?php echo $this->_var['user_rank']['rank_id']; ?>" name="user_price[]" value="<?php echo empty($this->_var['member_price_list']['\$user_rank']['rank_id']) ? '-1' : $this->_var['member_price_list']['\$user_rank']['rank_id']; ?>" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(<?php echo $this->_var['user_rank']['rank_id']; ?>)" size="8" />
...
?>
                <tr>
                  <td class="input_ie7">
                     ...
                     <?php endif; ?>
                     <span><?php echo $this->_var['lang']['volume_number']; ?></span> <input type="text" name="volume_number[]" size="8" value="<?php echo $this->_var['volume_price']['number']; ?>"/>
                     <span><?php echo $this->_var['lang']['volume_price']; ?></span> <input type="text" name="volume_price[]" size="8" value="<?php echo $this->_var['volume_price']['price']; ?>"/>
                  </td>
                </tr>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </table>
...
?>
        ...
        <table width="90%" id="groupgoods-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <td align="center">
              <p><?php echo $this->_var['lang']['price']; ?><br /><input name="price2" type="text" size="6" style="min-width:50px;"/></p>
