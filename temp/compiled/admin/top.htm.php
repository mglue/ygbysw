...
<li class="show_7" style="width:95px;"> <a href="http://www.68ecshop.com" class="qinghc" target="_blank" style="color:#FF0; font-weight:bold"><?php echo $this->_var['lang']['more_products']; ?></a></li></ul>
   <?php if ($this->_var['send_mail_on'] == 'on'): ?>
