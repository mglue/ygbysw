...
<div class="list-div package_list" id="listDiv">
<?php endif; ?>
...
?>
    <tr>
      <td class="first-cell">
        <?php if (( $this->_var['pack']['pack_img'] )): ?><a href = "../data/packimg/<?php echo $this->_var['pack']['pack_img']; ?>" target="_brank" style="padding:2px;"><img src="images/picflag.gif" width="16" height="16" border="0" alt="" /></a><?php else: ?><img src="images/picnoflag.gif" width="16" height="16" border="0" alt="" /><?php endif; ?>
