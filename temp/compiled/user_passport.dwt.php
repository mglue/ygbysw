 ...
 <div class="h_30"></div>
  <div class="reg  clearfix"> 
   <h2 class="passporttitle ">登录网站&nbsp;<span>您已经有账号？请您登录！如果您是新用户，请您<a href="user.php?act=register" target="_blank">免费注册</a></span></h2>
          ...
          <div class="l_box">
            <form action="user.php" method="post" name="loginForm" id="loginForm" onSubmit="return userLogin()">
              ...
              <label class="verify"> <span><?php echo $this->_var['lang']['comment_captcha']; ?></span>
                ...
                <img src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" name="captcha" alt="captcha" id="captchaImg" style="vertical-align: top;cursor: pointer;" onClick="this.src='captcha.php?is_login=1&'+Math.random()" /> </label>
    ...
    <div class="showtitle">
      <img src="themes/yiguofree/images/68ecshop_info.jpg"/>
      </div>
          ...
          <input name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" size="25" class="inputBg" /><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
            ...
            <tr>
              ...
              <td><input type="text" size="8" name="captcha" class="inputBg" />
                <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align:top;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" /></td>
            </tr>
            <?php endif; ?>
            <tr>
              <td>&nbsp;</td>
